...
    BANK_ID BIGINT REFERENCES bank (ID),
	FOREIGN KEY (COUNTRY_CODE) REFERENCES country (CODE),
  	CONSTRAINT ID_BANK_ID_Unique_index UNIQUE( ID, BANK_ID)
);
...
    BRANCH_ID BIGINT NOT NULL,
	...
	PRIMARY KEY (ID),
  	...
  	CONSTRAINT ACCOUNT_NUMBER_BRANCH_ID_Unique_Index UNIQUE( ACCOUNT_NUMBER, BRANCH_ID) /*,
    ACCOUNT_ID BIGINT,
	PAYEE_ID BIGINT,
...
CREATE TABLE account(
  ...
  CONSTRAINT USER_ID_CURRENCY_TYPE_Unique_Index UNIQUE( USER_ID, CURRENCY, TYPE),
  CONSTRAINT ACCOUNT_DETAILS_ID_Unique_Index UNIQUE(ACCOUNT_DETAILS_ID)
);
...
CREATE TABLE payee (
  ...
  PRIMARY KEY (ID),
  FOREIGN KEY (ACCOUNT_DETAILS_ID) REFERENCES account_details (ID),
  CONSTRAINT ACCOUNT_DETAILS_ID_PAYEE_Unique_Index UNIQUE(ACCOUNT_DETAILS_ID)
);
